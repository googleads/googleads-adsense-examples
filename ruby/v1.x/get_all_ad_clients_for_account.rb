...
def get_all_ad_clients_for_account(adsense, account_id)
  request = adsense.accounts.adclients.list(:accountId => account_id,
...
if __FILE__ == $0
  ...
  get_all_ad_clients_for_account(adsense, account_id)
end
